...
public class DescriptifControleur {
					...
					if (livr != null) {
						...
						if (tournee!=null) {
							...
							Date[] tmp=tournee.getTempsPassage()[tournee.getListeLivraison().indexOf(livr)];
					    		...
					    		//2e vBox qui affiche la duree et l'heure d'arrivee
					    		...
					    		//Affichage de la duree du trajet avec la fleche
	...
	/**
	 * La classe interaction permet de synchroniser la selection dans la liste textuelle
	 * et sur le plan.
	 * @param listView
	 */
