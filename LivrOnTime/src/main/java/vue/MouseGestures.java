...
/**
 * La classe MouseGestures gere toutes les interactions entre la souris et l
 * interface, elle implemente tous les Listeners.
 * 
 * @author Matthieu
 *
 */
public class MouseGestures {
	...
	/**
	 * La methode rendreDoubleCliquable gere l interaction des points au double
	 * clic : ouvre la pop-up de modifications.
	 * 
	 * @param node
	 */
	...
	/**
	 * La methode rendreCliquable gere l interaction des points au clic :
	 * selectionne le point et le trajet qui y mene.
	 * 
	 * @param node
	 */
	...
	/**
	 * La methode rendreLigneSurvolable gere l interaction des troncons au
	 * passage de la souris : affiche le nom de la rue.
	 * 
	 * @param node
	 */
