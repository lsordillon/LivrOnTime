...
/**
 * Cette classe est une classe utilitaire implementant l'algorithme de Dijkstra.
 * 
 * @author Matthieu
 *
 */
public class Dijkstra {
	...
	/**
	 * Methode principale de la classe, elle implemente l'algorithme de Dijkstra
	 * en calculant les plus cours chemins vers tous les noeuds d'un graphe a
	 * partir d'un noeud de depart.
	 * 
	 * @param plan,
	 *            le graphe utilise pour l'algorithme representant la ville de
	 *            Lyon
	 * @param ptDepart,
	 *            l'intersection de depart de l'algorithme
	 * 
	 */
	...
	/**
	 * Cette methode est utilisee pour l'algorithme de Dijkstra elle permet, a
	 * partir d'une liste de noeuds du graphe de trouver celui qui a la plus
	 * petite distance a partir de l'origine.
	 * 
	 * @param sommetsGris,
	 *            la liste de noeuds du graphe qu'on considere
