...
/**
 * La classe Intersection stocke les intersections du plan.
 * Pour chacune on memorise son id, ses coordonnees ainsi que la liste
 * des troncons partant d elle.
 * Une fois les plus courts chemins calcules a l'aide de Dijkstra on stocke
 * egalement l intersection qui la precede dans le chemin et sa distance par
 * rapport a l origine du calcul.
 * @author Matthieu
 *
 */
public class Intersection{
	...
	/**
	 * Constructeur de la classe Intersection, il cree l objet
	 * a partir d un id et de coordonnees recuperes dans un fichier xml
	 * @param id
	 * @param x
	 * @param y
	 */
