...
/**
 * La classe DemandeLivraison permet de construire un objet qui stocke une liste
 * de livraison, une adresse d'entrepot et une heure de depart. C est a partir
 * de cet objet qu on pourra calculer une tournee.
 * 
 * @author Matthieu
 *
 */
public class DemandeLivraison {
	...
	/**
	 * Constructeur de la classe DemandeLivraison, il cree l objet a partir d
	 * une liste de livraisons, d un entrepot et d un plan.
	 * 
	 * @param livraisons
	 * @param entrepot
	 * @param plan
