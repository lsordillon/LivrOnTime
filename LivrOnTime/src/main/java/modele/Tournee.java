...
/**
 * La classe Tournee construit et stocke l itineraire entre tous les points de
 * livraison a atteindre. Elle stocke egalement l heure de depart et l heure d
 * arrivee ainsi que les temps de passage aux differentes livraisons.
 * 
 * @author Matthieu
 *
 */
public class Tournee {
	...
	/**
	 * Le constructeur de la classe Tournee il cree l objet a partir d une liste
	 * de chemin et d une demande de livraison
	 * 
	 * @param itineraire
	 * @param dl
	 */
	...
	/**
	 * La methode initTempsPassage initialise le tableau des temps de passage.
	 */
	...
	/**
	 * La methode SupprimerLivraison permet d'enlever une livraison donnee de la
	 * tournee.
	 * 
	 * @param plan
	 * @param inter
	...
	/**
	 * La methode AjouterLivraison permet d ajouter une livraison dans la
	 * tournee a un index donnee.
	 * 
	 * @param plan
	 * @param inter
	 * @param l
	...
	/**
	 * Cette methode ModifierLivraison permet de modifier la duree d'une
	 * livraison donnee.
	 * 
	 * @param plan
	 * @param liv
	...
	/**
	 * Cette methode ModifierLivraison permet de modifier la plage horaire d une
	 * livraison donnee.
	 * 
	 * @param plan
	 * @param liv
	...
	/**
	 * La methode VerifierPlagesHorairesUneLiv permet de verifier que l heure d
	 * arrivee sur le lieu de la livraison respecte bien la plage horaire
	 * associee.
	 * 
	 * @param liv
	 * @return
	...
	/**
	 * La methode VerifierPlagesHorairesTournee permet de verifier les plages
	 * horaires pour toute la tournee.
	 * 
	 * @return
	 */
	...
	/**
	 * <p>
	 * Getter de l'attribut tempsPassage qui recense les temps de passage
	 * estimes aux differents points de livraison. Il s'agit d'un tableau 2D
	 * contenant :
	 * </p>
	 * <ul>
	 * <li>en premiere colonne (tempsPassage[i][0]) la date d'arrivee sur le
	 * point de livraison d'index i</li>
	 * <li>en deuxieme colonne (tempsPassage[i][1]) la date de debut de
	 * livraison</li>
	 * </ul>
	 * <p>
	 * Toutes les dates du tableau sont au format normal. On peut les traiter
	 * avec la classe {@link SimpleDateFormat} qui permet de formater facilement
	 * l'affichage.
	 * </p>
	 * <p>
	 * Pour recuperer le temps d'attente a partir de ce tableau, il suffit de
	 * faire la soustraction entre : la date de livraison et la date d'arrivee
	 * sur le point de livraison :
	 * </p>
	 * <p>
	 * tempsPassage[i][1].getTime()-tempsPassage[i][0].getTime()
	 * </p>
	 * 
	 * <p>
	 * ATTENTION : La duree obtenue doit etre transformee pour etre utilisee par
	 * la classe SimpleDateFormat en lui soustrayant 1 heure en millisecondes (3
	 * 600 000). Vous pouvez retrouver un exemple simple a la fin du
	 * constructeur de {@link Tournee#Tournee(ArrayList, DemandeLivraison)}.
	 * 
