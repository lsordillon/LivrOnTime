...
/**
 * La classe Livraison stocke toutes les informations concernant une livraison a
 * effectuer lors de la tournee : l adresse, la duree, et eventuellement la
 * plage horaire associee.
 * 
 * @author Matthieu
 *
 */
public class Livraison {
	...
	/**
	 * Constructeur de la classe Livraison, il cree l objet a partir d une
	 * adresse et d une duree.
	 * 
	 * @param duree
	 * @param destination
	 */
	...
	/**
	 * Constructeur de la classe Livraison, il cree l objet a partir d une
	 * adresse, d une duree et d une plage horaire.
	 * 
	 * @param duree
	 * @param destination
	 * @param debut
